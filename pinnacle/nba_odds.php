...
$api_settled = finished_games_call(4,487);
$api_upcoming = odds_call(4,487);
...
$select_query = "SELECT * FROM games WHERE game_time > '$yesterday_date' AND league_id = 55555";
$db_upcoming = [];
...
// // 			echo "matching: " . $api_game['API_game_id'];
// // 			echo "<br>";
// // 			$matchupFound = true;
// // 			break;
// // 		}
...
// */
// function propertyCheck($db_game, $api_game, $prop) {
// 	global $connection;
...
// */
// function concatenateValues($api_game, $prop) {
// 	global $values;
// 	if (isset($api_game[$prop])) {
...
// 			propertyCheck($db_game, $api_game, 'home_spread');
// 			propertyCheck($db_game, $api_game, 'spread_odds_a');
// 			propertyCheck($db_game, $api_game, 'spread_odds_h');
// 			propertyCheck($db_game, $api_game, 'moneyline_odds_a');
// 			propertyCheck($db_game, $api_game, 'moneyline_odds_h');
// 			propertyCheck($db_game, $api_game, 'overunder_points');
// 			propertyCheck($db_game, $api_game, 'overunder_odds_o');
// 			propertyCheck($db_game, $api_game, 'overunder_odds_u');
// 			$gameIdFound = true;
// 			break;
// 		}
// 	}
...
// 			$values = "{$api_game['API_game_id']}, 487, {$home_id}, {$away_id}, ";
...
// 			}
// 			concatenateValues($api_game, 'home_spread');
// 			concatenateValues($api_game, 'spread_odds_h');
// 			concatenateValues($api_game, 'spread_odds_a');
// 			concatenateValues($api_game, 'moneyline_odds_h');
// 			concatenateValues($api_game, 'moneyline_odds_a');
// 			concatenateValues($api_game, 'overunder_points');
// 			concatenateValues($api_game, 'overunder_odds_o');
// 			concatenateValues($api_game, 'overunder_odds_u');
